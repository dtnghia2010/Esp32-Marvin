...
model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
    filepath="checkpoint.weights.h5",  # Change the extension to `.weights.h5`
    monitor='val_accuracy',
    mode='max',
    save_best_only=True,
    save_weights_only=True  # Ensure this argument is set
)
...
model2 =  keras.models.load_model("checkpoint.weights.h5")
